=== Songer Cleanup and Basic Functions ===
Contributors: austinvernsonger
Tags: comments, spam
...
Head section cleanup and many usual settings used on every website setup as images settings and size, privacy, and basic admin customisations.
